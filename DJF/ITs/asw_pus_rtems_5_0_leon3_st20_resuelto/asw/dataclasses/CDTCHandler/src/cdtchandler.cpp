...
void CDTCHandler::ExecHK_FDIRTC() {
	...
	if (!error) {
		...
		case (3):
			...
			break;
		case (5): // AÑADIDO: Ejecución del Servicio 5 (Eventos)
			pus_service5_exec_tc(&mTCHandler);
			break;

		case (12): // AÑADIDO: Ejecución del Servicio 12 (Monitorización)
			pus_service12_exec_tc(&mTCHandler);
			break;
		case (4): // AÑADIDO: Ejecución del Servicio 12 (Monitorización)
